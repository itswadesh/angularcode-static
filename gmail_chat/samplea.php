<?php
session_start();
$_SESSION['chatuser'] = '13';
$_SESSION['chatuser_name'] = 'itswadesh'; //; Must be already set
...
<h2><a style='color:green' href="javascript:void(0)" onclick="javascript:chatWith('12','VimlaJonko')">Chat with VimlaJonko</a></h2>
<!-- YOUR BODY HERE -->
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
